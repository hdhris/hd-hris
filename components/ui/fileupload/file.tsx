...
const FileDropzone = React.forwardRef<HTMLInputElement, InputProps>(({
    ...
    return (<div className="w-full">
        <div className="flex w-full flex-col gap-2">
            ...
            {/* Selected Files */}
            {value?.map(({file, abortController, progress}, i) => (<div
                key={i}
            ...
            >
                ...
                {/* Progress Bar */}
                <div className="flex items-center gap-x-3 whitespace-nowrap mt-2">
                    ...
                    <div className="w-6 text-end">
                        <span
                            className="text-sm text-gray-800 dark:text-white">{typeof progress === 'number' && Math.round(progress) + '%'}</span>
                    </div>
                </div>
