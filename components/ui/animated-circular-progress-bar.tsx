...
export default function AnimatedCircularProgressBar({
    ...
    useEffect(() => {
        if (onValueChange) {
            onValueChange(currentPercent);
        }
    }, [currentPercent, onValueChange])
    return (<div
    ...
    >
        <svg
            ...
            viewBox="0 0 100 100"
        >
            {currentPercent <= 90 && currentPercent >= 0 && (<circle
                cx="50"
                cy="50"
                r="45"
                strokeWidth="10"
        ...
        <span
            ...
            className="duration-1000 delay-0 absolute inset-0 m-auto size-fit ease-linear animate-in fade-in"

        >
            <div className="flex flex-col items-center">
                <CountUp start={0} end={currentPercent} decimals={2} suffix="%"/>
            <Typography className="text-slate-700/50 text-sm">{explain}</Typography>
            </div>
