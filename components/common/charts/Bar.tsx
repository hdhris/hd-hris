...
export default function BarChart({color, data, height, width, style}: BarChartProps) {
    const option: ApexOptions = {
        chart: {
            ...
            bar: {
                horizontal: false, columnWidth: "50%", borderRadiusApplication: "end", borderRadius: 2,
            },
        ...
        states: {
            ...
            floating: false, labels: {
                show: true, style: {
                    fontFamily: "Inter, sans-serif", cssClass: 'text-xs font-normal fill-primary dark:fill-primary-400'
                }
            }, axisBorder: {
                show: false,
            }, axisTicks: {
    ...
    const series: ApexOptions["series"] = [{
        color: color ? color : "primary", data: data
    },]
