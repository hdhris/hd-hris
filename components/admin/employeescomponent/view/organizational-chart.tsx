// components/admin/employeescomponent/view/organizational-chart.tsx
"use client";
...
// import { isEmployeeAvailable } from "@/lib/utils/employeeUtils"; // Adjust import path as needed
      ...
      <div className="flex flex-col items-center">
        ...
        >
          <div className="text-center group">
            <h3 className="text-sm font-semibold mb-1 transition-colors group-hover:text-primary">
              {position.name}
            </h3>
