...
const ScheduleModal: React.FC<ScheduleModalProps> = ({
    ...
    const handleSave = (value: any) => {
        const newSchedule: BatchSchedule = {
            created_at: selectedSchedule ? selectedSchedule.created_at : new Date().toISOString(),
            ...
            footer={
                <>
                    {selectedSchedule && (
                        <Button
                            className="ms-auto"
                            {...uniformStyle({ color: "danger", variant: "light" })}
                            onPress={() => {
                    ...
                    <Button
                        ...
                        type="submit"
                        form="schedule-form"
                        className={!selectedSchedule ? "ms-auto": undefined}
                    >
