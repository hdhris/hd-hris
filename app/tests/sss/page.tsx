...
export default function Component() {
    ...
    const calculateSSS = (monthlySalary: number) => {
        const {
            minSalary, maxSalary, minMSC, maxMSC, mscStep,
            regularEmployeeRate, regularEmployerRate, ecThreshold,
            ecLowRate, ecHighRate, wispThreshold
        } = sssData;
        ...
        if (monthlySalary <= minSalary) {
            msc = minMSC;
            console.log("Min MSC: ", minMSC)
        } else if (monthlySalary >= maxSalary) { // Fixed the comparison operator
            msc = maxMSC;
            console.log("Max MSC: ", maxMSC)
        } else {
