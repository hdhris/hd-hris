...
import { Avatar, DateValue, Link, Selection, Textarea, User } from "@nextui-org/react";
    ...
    return (
        <div className="flex gap-4 h-full">
            ...
            <TableData
                ...
                isLoading={isLoading}
                disabledKeys={
                    isFocused ? new Set(Array.from(data?.employees.map((emp) => String(emp.id)) || [])) : new Set([])
                }
                config={{
                    columns: [
